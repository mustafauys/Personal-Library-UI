import 'package:personal_library/data/data.dart';
import 'package:personal_library/model/speciality.dart';
import 'package:personal_library/views/doctor_info.dart';
import 'package:flutter/material.dart';

String selectedCategorie = "Yetişkinler";
...
class _HomePageState extends State<HomePage> {
  List<String> categories = ["Yetişkinler", "Çocuklar", "Kadınlar", "Erkekler"];
